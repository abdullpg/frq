...
/* END Hati Berjatuhan */
  ...
  function mulaitextseco() {
	  new TypeIt("#textsec2first", {
	    ...
	    .type("Ini Serius Ini Bukan Gombal,") 
	    .pause(500) 
	    .delete(null, { speed: 30 }) 
	    .pause(100) 
	    .exec(() => {textsec2first.style="font-size:20px";})
	    .type("Kamu Mau Ngga<br>Jadi Pacar Aku? 🫣") 
	    .pause(50)
	    .exec(() => {
  ...
  function fungsimau(){
    ...
    setTimeout(function() {third_stiker.style="margin-top:0px;margin-bottom:15px;transform:scale(1);transition:all .9s ease"}, 500);
    new TypeIt("#textsec3", {
      strings: ["" + initextsec3], startDelay: 700, speed: 27, cursor: true,
      afterComplete: function(){
          textsec3.innerHTML = initextsec3;
          third_stiker.style.transform = "scale(0)";
	      setTimeout(function() {
	          third_stiker.style.transform = "scale(1)";
	          inistiker5.src = inistiker6.src;
	      }, 300);
  ...
  function tes(){
    sentuh.style="margin-top:100px;transform:scale(2.3)";
    setTimeout(function() {
          if(fungsi==0){
            window.scrollBy({top: tinggi,behavior: 'smooth'});
            fungsi = 1;skrg++;
            if(skrg==2){fungsi=0;setTimeout(mulaitextseco,500);setTimeout(function() {second_stiker.style="margin-top:0px;transform:scale(.9);transition:all .7s ease";}, 500);}
          }
    }, 100);
  }
...
function showSentuh(){sentuh.style="transform: scale(1.2);";}
vgantiTeks1 = 0;
function gantiTeks1(){
    ...
    else {vgantiTeks1 = teks2.innerHTML;teks1.innerHTML = "";teks3.style="display:none";teks1.style="font-size:19px;transform: scale(1);transition:all .75s ease";gantiTeks1nimasi();}
}
function gantiFoto1(){
    first_stiker.style="transform: scale(0);";
    setTimeout(function() {
