...
*/
  ...
  function mulaitextseco(){
  	stikersec2.style="margin-top:-100px;margin-bottom:10px;transform:scale(.9);transition:all .7s ease";
  	scrollContainer.style="transform: scale(1)";
  	new TypeIt("#textsec2", {
      strings: ["" + initextsec2], startDelay: 200, speed: 50, /* deff 55 */ cursor: false,
      afterComplete: function(){
      	textsec2.innerHTML = initextsec2;
          setInterval(berjatuhan,200);
          clearInterval(scrollInterval);
          
          stikersec2.style="margin-top:-100px;margin-bottom:10px;transform:scale(0);transition:all .7s ease";
          setTimeout(function() {
              stikersec2.style = "margin-top:-100px;margin-bottom:10px;transform:scale(.9);transition:all .7s ease";
...
function tes(){
  ...
  setTimeout(function() {
        if(fungsi==0){
           ...
           if(skrg==3){fungsi=0;setTimeout(mulaitextseco,800);setTimeout(function() {stikersec2.style="transform:scale(1);transition:all .7s ease";}, 500);}
